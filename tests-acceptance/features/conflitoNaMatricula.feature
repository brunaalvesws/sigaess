...
Given Criei um usuário com o email "fgmB@cin.com", o nome "Filipe Melo B", a senha "filipe12345" e escolhi o tipo Professor
When Tento fazer login com email "fgmB@cin.com" e senha "filipe12345"
Then Vou para a tela inicial do usuário
Then Estou logado como Professor
When Clico no botão de adicionar nova cadeira
When Adiciono o nome da disciplina "Introdução a Programação 2", o departamento "CIn", o total de vagas "60" e marco os horários "seg8, seg9, qua10, qua11"
...
Given Criei um usuário com o email "bawsA@cin.com", o nome "Bruna A", a senha "bruna12345" e escolhi o tipo Aluno
When Tento fazer login com email "bawsA@cin.com" e senha "bruna12345"
Then Vou para a tela inicial do usuário
Then Estou logado como Aluno
When Seleciono o departamento "CIn" e a cadeira "Introdução a Programação 2"
